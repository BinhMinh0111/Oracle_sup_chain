--------------------------------------------------------
--  File created - Sunday-June-19-2022   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "DOAN"."SEQ_HD_ID"  MINVALUE 1 MAXVALUE 99999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "DOAN"."SEQ_NV_ID"  MINVALUE 1 MAXVALUE 99999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_PN_ID
--------------------------------------------------------

   CREATE SEQUENCE  "DOAN"."SEQ_PN_ID"  MINVALUE 1 MAXVALUE 99999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "DOAN"."SEQ_TH_ID"  MINVALUE 1 MAXVALUE 99999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for View V_HD_TONG_TIEN
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "DOAN"."V_HD_TONG_TIEN" ("SOHD", "TONG_TIEN") AS 
...
;
  GRANT DELETE ON "DOAN"."V_HD_TONG_TIEN" TO "BINHMINH";
  GRANT INSERT ON "DOAN"."V_HD_TONG_TIEN" TO "BINHMINH";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "DOAN"."XEM_TON_KHO" ("THANG", "NAM", "MA_NGUYEN_LIEU", "TEN_NGUYEN_LIEU", "SO_LUONG_TON") AS 
  SELECT "THANG","NAM","MA_NGUYEN_LIEU","TEN_NGUYEN_LIEU","SO_LUONG_TON" FROM TON_KHO
;
...
SET DEFINE OFF;
Insert into DOAN.CT_PHIEU_NHAP (MA_PHIEU_NHAP,MALO,THOI_HAN) values ('PN00001','LH00001',4);
...
Insert into DOAN.NHAN_VIEN (MANV,CMND,HO_LOT,TENNV,TUOI,GIOI_TINH,SDT,CHUC_VU,DEL_STATUS) values ('NV00002',939746452,'Lê','Th? N',25,'N?',785975795,'Qu?n lý','ACTIVE');
...
','HYUNDAI','ACTIVE');
--------------------------------------------------------
--  DDL for Trigger HD_TONG_TIEN
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "DOAN"."HD_TONG_TIEN" 
...
END;
/
ALTER TRIGGER "DOAN"."HD_TONG_TIEN" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TRIG_UPDATE_TON_KHO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "DOAN"."TRIG_UPDATE_TON_KHO" 
...
END;
/
ALTER TRIGGER "DOAN"."TRIG_UPDATE_TON_KHO" ENABLE;
--------------------------------------------------------
--  DDL for Procedure NHAP_TONG_TIEN
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "DOAN"."NHAP_TONG_TIEN" (input_sohd char)
AS
v_TONG_TIEN FLOAT;
BEGIN
...
/
--------------------------------------------------------
--  DDL for Function TINH_TONG_TIEN
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "DOAN"."TINH_TONG_TIEN" (input_sohd char) RETURN FLOAT
AS
v_TONG_TIEN FLOAT;
BEGIN
SELECT SUM(THANH_TIEN)
